package com.rjs.myshows.core.service.mdb.tmdb;
...
import com.rjs.myshows.core.service.ShowTypeService;
import com.rjs.myshows.core.service.mdb.MdbService;
import com.rjs.myshows.core.service.mdb.ShowSummary;
import com.rjs.myshows.core.service.mdb.tmdb.domain.TmdbGenre;
import com.rjs.myshows.core.service.mdb.tmdb.domain.movie.*;
import com.rjs.myshows.core.service.mdb.tmdb.domain.tv.ContentRating;
import com.rjs.myshows.core.service.mdb.tmdb.domain.tv.TvDetail;
import com.rjs.myshows.core.service.mdb.tmdb.domain.tv.TvListing;
import com.rjs.myshows.core.util.UrlBuilder;
...
import static com.rjs.myshows.core.domain.DomainConstants.MOVIE_TYPE;
import static com.rjs.myshows.core.domain.DomainConstants.TV_TYPE;
...
public class TmdbService extends MdbService {
	...
	public TmdbService(CoreConfig coreConfig, ImageService imageService, TmdbProperties tmdbProperties,
					   ShowService showService, ShowTypeService showTypeService, DateTimeFormatter dateFormat) {
		super(coreConfig, imageService);
	...
	@Override
	public Optional<ShowDto> addShow(String showTypeName, String tmdbId) {
		switch (showTypeName) {
			case MOVIE_TYPE:
...
//							break;
	...
	private void downloadPosterImage(ShowEntity show, String tmdbPosterPath) {
		...
		String localImgPath = coreConfig.getLocalImagePath(show.getId());

		try {
			URL posterUrl = new URL(tmdbProperties.getImageUrl() + tmdbProperties.getImageNormalPath() + tmdbPosterPath);
			imageService.saveImage(posterUrl, localImgPath, "poster");
		}
		...
		try {
			...
			imageService.saveImage(posterUrl, localImgPath, "poster_thumb");
		}
		catch (MalformedURLException e) {
